...
class VoicePipeline:
    ...
    def process_event(self,event,exercise,metrics):
        ...
        if event == "workout_started":
            text = "Let's begin your workout. Stay focused and maintain proper form."

        elif event == "set_completed":
            text = "Great job! You have completed a set."

        elif event == "workout_completed":
            text = "Excellent work! You have completed your workout."

        elif event == "no_pose_detected":
            text = "Please step into the camera frame."
